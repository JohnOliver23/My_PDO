...
public class TelaAtualizaCliente extends JFrame {
	...
	private static Cliente c;  //esse atributo tem que ser estatico
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaAtualizaCliente frame = new TelaAtualizaCliente(c);
	 ...
	 * Create the frame.
	 */
	public TelaAtualizaCliente(Cliente c) {
		...
		btnAtualiza.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					Cliente cl = Fachada.AtualizaCliente(c.getId(),nome, sobrenome, data);
					JOptionPane.showMessageDialog(null, "Cliente "+cl.getNome()+" atualizado com Sucesso");
					txtNome.setText("");
					txtSobreNome.setText("");
					txtData.setText("");
					txtNome.requestFocus();
					dispose();
					TelaListaCliente t = new TelaListaCliente();
					t.setVisible(true);
				}
				catch(Exception e1){
