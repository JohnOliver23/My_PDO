		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					Cliente c = Fachada.cadastrarCliente(nome, sobrenome, data);
					JOptionPane.showMessageDialog(null, "Cliente "+c.getNome()+" cadastrado com Sucesso","Ok",JOptionPane.INFORMATION_MESSAGE);
					txtNome.setText("");
